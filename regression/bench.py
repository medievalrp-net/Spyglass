...
QUERIES = [
    ...
    {
        "id": "all-breaks-30d",
        "v2": "omniv2 search a:break t:30d -g -ng",
        "v1": "omni search a:break t:30d -g -ng",
        "notes": "wide match, ungrouped",
    },
    {
        "id": "all-places-30d",
        "v2": "omniv2 search a:place t:30d -g -ng",
        "v1": "omni search a:place t:30d -g -ng",
    ...
    # Player + event: tests (source.playerId, occurred) index on v2.
    {
        ...
        "v2": "omniv2 search p:Alice a:break t:30d -g -ng",
        "v1": None,
    ...
    {
        "id": "stone-breaks-30d",
        "v2": "omniv2 search b:STONE a:break t:30d -g -ng",
        "v1": "omni search b:STONE a:break t:30d -g -ng",
        "notes": "material+event",
    },
    # Narrow time window: only recent docs, almost no sort work.
    {
        "id": "narrow-1h",
        "v2": "omniv2 search a:break t:1h -g -ng",
        "v1": "omni search a:break t:1h -g -ng",
        "notes": "narrow time window",
    },
    {
        "id": "narrow-1d",
        "v2": "omniv2 search a:break t:1d -g -ng",
        "v1": "omni search a:break t:1d -g -ng",
        "notes": "1-day window",
    },
    {
        "id": "narrow-7d",
        "v2": "omniv2 search a:break t:7d -g -ng",
        "v1": "omni search a:break t:7d -g -ng",
        "notes": "7-day window",
    },
    # Composite with player + material + event.
    {
        "id": "composite-alice-stone",
        "v2": "omniv2 search p:Alice b:STONE a:break t:30d -g -ng",
        "v1": None,
    ...
    # architectural cost.
    {
        ...
        "v2": "omniv2 search a:break t:30d -g",
        "v1": "omni search a:break t:30d -g",
...
PAGETURN_SEARCH = "omniv2 search a:break t:30d -g -ng"
...
def bench_pageturn(rcon_factory, trials, warmup, inter_delay=0.05):
    ...
    `omniv2 page N` round trips. The PageCache.show path is fully
