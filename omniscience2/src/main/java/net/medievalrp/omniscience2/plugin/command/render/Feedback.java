 ...
 * matching v1's {@code «Omniscience» (Error) ...} house style so an operator
 * moving between plugins sees consistent chat framing.
 */
@ApiStatus.Internal
public final class Feedback {

    /** «Omniscience» — green brackets, aqua name, reused across every message. */
    ...
    /** `«Omniscience»<green>message</green>` — matches v1's Formatter.success. */
    ...
    /** `«Omniscience» --- TARGET at x y z ---` — used by the wand before a lookup. */
