...
public final class RecordingSupport {
     ...
     *       net.medievalrp.omniscience2.plugin.pipeline.AsyncRecorder}
     ...
     * net.medievalrp.omniscience2.plugin.util.ItemSerialization},
     * {@link net.medievalrp.omniscience2.plugin.util.BlockSnapshots})
