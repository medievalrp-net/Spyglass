 ...
 * no matter how far behind the drain is. This matches the Omniscience
...
public final class AsyncRecorder implements Recorder {
    ...
    public void record(EventRecord record) {
        ...
        try {
            ...
            logger.warning("Omniscience2 committed-hook threw: " + hookFailure);
        }
        ...
        if (depth > warnThreshold) {
            ...
            if ((firstCrossing || doubledSinceLast)
                ...
                logger.warning("Omniscience2 recorder queue depth " + depth
        ...
        try {
            while (running.get() || !queue.isEmpty()) {
                ...
                try {
                    ...
                    logger.warning("Omniscience2 WAL write failed (" + walFailure.getMessage()
                ...
                while (true) {
                    try {
                        ...
                        if (consecutiveFailures == 1 || consecutiveFailures % 10 == 0) {
                            logger.warning("Omniscience2 recorder save failed ("
    ...
    private void flushRemaining(long deadlineNanos) {
        ...
        try {
            ...
            logger.warning("Omniscience2 WAL write failed at shutdown ("
