package net.medievalrp.omniscience2.plugin.rollback;
 ...
 * matching {@link net.medievalrp.omniscience2.api.rollback.RollbackResult}
 * entries.
 */
@ApiStatus.Internal
    ...
    static boolean[] applyAll(List<RollbackEffect.BlockReplace> effects) {
        ...
        for (Map.Entry<World, java.util.List<Integer>> entry : indicesByWorld.entrySet()) {
            ...
            try (EditSession session = WorldEdit.getInstance().newEditSession(weWorld)) {
                ...
                Bukkit.getLogger().warning("Omniscience2 FAWE rollback batch failed: " + thrown.getMessage());
            }
        }
        return applied;
    }
