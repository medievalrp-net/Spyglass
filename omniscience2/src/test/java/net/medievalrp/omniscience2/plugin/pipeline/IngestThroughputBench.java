...
/**
 * Ingest throughput benchmark: Omniscience v2 vs synthetic v1-equivalent.
 *
 ...
 * :omniscience2:ingestBench}. Gated on Docker availability; skipped
 ...
 * noise.
 *
 * <p><b>Why compare to v1?</b> Omniscience2 replaces Omniscience v1 in
 ...
 *       EntryQueueRunner} + {@code MongoStorageHandler} in Omniscience-Core.)</li>
...
class IngestThroughputBench {
    ...
    private static final long SUSTAINED_TARGET_RATE = envLong("OMNI_BENCH_SUSTAINED_RATE", 10_000L);
    private static final long SUSTAINED_DURATION_SEC = envLong("OMNI_BENCH_SUSTAINED_SEC", 15L);
    private static final int BURST_THREADS = (int) envLong("OMNI_BENCH_BURST_THREADS", 8L);
    private static final int BURST_PER_THREAD = (int) envLong("OMNI_BENCH_BURST_PER", 25_000L);
    private static final int OVERLOAD_RECORDS = (int) envLong("OMNI_BENCH_OVERLOAD", 200_000L);
    ...
    private static final int V2_WARN_THRESHOLD = (int) envLong("OMNI_BENCH_V2_CAP", 10_000L);
    ...
    private static final class Harness {
        ...
        static Harness v2(String mongoUri, int warnThreshold) {
            ...
            String db = "Omniscience2Bench_" + System.nanoTime();
        ...
        static Harness v1(MongoClient shared) {
            ...
            String db = "OmniscienceBench_" + System.nanoTime();
