 ...
 * net.medievalrp.omniscience2.api.Omniscience2Api#registerDisplayRenderer}.
 *
 * <h2>Threading</h2>
 *
 ...
 * Omniscience2 renderer falls back to the default rendering for that
 ...
 * Omniscience2 plugin instance. There is no unregister path; reload
...
public interface DisplayRenderer {
     ...
     * @param defaultTarget what Omniscience2 would have rendered
