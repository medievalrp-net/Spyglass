 ...
 * <pre>{@code
 * Omniscience2Api api = Bukkit.getServicesManager()
 *         .load(Omniscience2Api.class);
 * }</pre>
 *
 * <h2>Threading</h2>
 *
...
public interface Omniscience2Api {
    ...
    /**
     * Register a custom query-parameter handler so {@code /omni2
    ...
    /**
     * Register a custom flag handler so {@code /omni2 search
     ...
     * {@link net.medievalrp.omniscience2.api.rollback.RollbackEffect.Custom}
     * payloads with a matching {@code type} are routed to your code
     * during {@code /omni2 rollback} and {@code /omni2 undo}.
     *
    ...
    /**
     * The set of event names this Omniscience2 install is configured
    ...
    /**
     * The Omniscience2 plugin's logger. Use this for diagnostics that
     * should appear under the Omniscience2 log scope rather than your
