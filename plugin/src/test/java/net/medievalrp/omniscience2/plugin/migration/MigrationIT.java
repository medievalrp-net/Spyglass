...
class MigrationIT {
    ...
    void setup() {
        ...
        config = new Omniscience2Config(
                new Omniscience2Config.Database(uri, "Omniscience2", "EventRecords"),
                new Omniscience2Config.Storage(Duration.parse("4w"), 1000, Duration.parse("5s")),
                new Omniscience2Config.Defaults(true, 5, Duration.parse("3d")),
                new Omniscience2Config.Limits(250, 1000, 10000, 50),
                Map.of(),
                new Omniscience2Config.Tool(null));
    ...
    void migratesSampleV1Corpus() {
        MongoDatabase v1Db = client.getDatabase("Omniscience");
        ...
        long written = client.getDatabase("Omniscience2")
    ...
    void dryRunProducesNoWrites() {
        ...
        client.getDatabase("Omniscience2").getCollection("EventRecords").drop();
        recordStore.close();
        recordStore = new MongoRecordStore(config.database(), new IndexManager());
