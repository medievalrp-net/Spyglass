...
import net.medievalrp.omniscience2.api.event.ContainerInteractRecord;
...
public final class ResultRenderer {
    ...
    public ResultRenderer(Omniscience2Api api, Omniscience2Config config) {
        this.api = api;
        this.config = config;
    }
    ...
    public Component renderAggregation(QueryResult.RecordAggregation aggregation) {
        ...
        return line(sample, count, true, false, java.util.EnumSet.noneOf(
                net.medievalrp.omniscience2.api.query.Flag.class));
    }

    public Component renderSingle(EventRecord record, java.util.EnumSet<net.medievalrp.omniscience2.api.query.Flag> flags) {
        java.util.EnumSet<net.medievalrp.omniscience2.api.query.Flag> safe = flags == null
                ? java.util.EnumSet.noneOf(net.medievalrp.omniscience2.api.query.Flag.class)
                : flags;
        boolean extended = safe.contains(net.medievalrp.omniscience2.api.query.Flag.EXTENDED);
    ...
    private Component line(EventRecord record, long count, boolean grouped, boolean extended,
                           java.util.EnumSet<net.medievalrp.omniscience2.api.query.Flag> flags) {
        ...
        if (extended && record.location() != null) {
            ...
            // teleport via /omni2 tele; for now it's plain text.
